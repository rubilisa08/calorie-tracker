...
## 알려진 제약사항 (MVP)
- 음식 데이터는 자체 조사한 약 262개 항목만 지원합니다 (국밥·면류·한식일품·탕찌개·죽·일식·중식·양식·분식·배달음식·프랜차이즈·디저트·유행음식 메뉴 포함). 영양성분은 일반적인 평균값 기준 추정치이며, 초기 164개 중 71개(원재료 위주)는 외부 공식 자료와 개별 대조해 8개를 수정했고, 이후 추가된 98개는 1차 조사 수준입니다 — 검증 방법·범위·한계는 [DATA_ACCURACY.md](DATA_ACCURACY.md) 참고.
