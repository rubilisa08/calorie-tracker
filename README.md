...
문서: [PRD.md](PRD.md) · [TECH_SPEC.md](TECH_SPEC.md) · [MVP_SCOPE.md](MVP_SCOPE.md)
...
## 알려진 제약사항 (MVP)
- 음식 데이터는 자체 조사한 약 164개 항목만 지원합니다 (배달음식·프랜차이즈·디저트·유행음식 메뉴 포함). 영양성분은 일반적인 평균값 기준 추정치입니다.
